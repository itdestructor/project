...
let infoObject = {
    first : {
        ...
        questions : { firstQuestion : 'Обеспечить себя и семью 👨‍👩‍👧‍👦' ,
    ...
    second :{ questionTitle : '2.У Вас есть опыт инвестирования? 🤑',
    questions : { firstQuestion : 'Да, успешно 😊' ,
    ...
    third :{ questionTitle : '3.Вы знакомы с компанией Tesla X? Она позволяет зарабатывать от €4000 в месяц! 🤩',
    questions : { firstQuestion : 'Да, слышал в СМИ, интернете 📣' ,
    ...
    last :{ questionTitle : 'При минимальных вложениях от $250 вы можете получать пассивный доход 300% еженедельно уже сейчас!🔥🎁',
    questions : { firstQuestion : 'Заполнить форму и начать получать прибыль🎁🤯' },
    handler : '4',
    progressBar : '95%',
    } ,
}
...
backButton.addEventListener('click',(event) =>{
    ...
    if(globalCount < 4 && secondQuestionArea.classList.contains('visually-hidden')){
